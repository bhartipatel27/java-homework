Feature: Bookcategory
  ...
  Background: I should be able ot see homepage
    Given I enter URL"https://demo.nopcommerce.com/" in browser
    And   I am on home page

  Scenario Outline: I should be able to see top menu tabs on homepage with categories
    When I am on home page
    Then i Should be able ot see top menu tabs with "<categories>"
    Examples:
    |categories|
    |computer  |
    |Electronic|
    ...
    Scenario Outline: I should be able to see book page with filters
      When I select book category from top many tabs on home page
      Then I should be navigated to book category
      And  I should be able ot see "<filters>"
    Examples:
      |filters|
      |Short by|
      |Display |
    ...
    Scenario Outline: I should be able to see list of terms of each filter
      ...
      Scenario Outline: I should be able to choose any filter option with specific result
        ...
        Then  I should be able ot choose any filter option from the list
        ...
        Scenario Outline: I should be able to see product display format according display format type as per given picture in srs
          Given I am on book page
          When  I click on "<display format icon>"
          Then  I should be able ot see product display format according display format type as per given picture in SRS document
          Examples:
          |display format icon|
          |Grid               |
          |List               |